...
func init() {
	...
	utilruntime.Must(dijkstrav1.AddToScheme(scheme))
	utilruntime.Must(dijkstrav2.AddToScheme(scheme))
	utilruntime.Must(scheme.SetVersionPriority(dijkstrav2.SchemeGroupVersion, dijkstrav1.SchemeGroupVersion))
...
func main() {
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:       "c3b39884.jinli.io",
