...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter, dijkstraclient dijkstraclient.DijkstraInterface) (*Storage, error) {
	...
	store := &genericregistry.Store{
		NewFunc:                   func() runtime.Object { return &dijkstra.KnownNodes{} },
		NewListFunc:               func() runtime.Object { return &dijkstra.KnownNodesList{} },
		PredicateFunc:             MatchKnownNodes,
		DefaultQualifiedResource:  dijkstra.Resource("knownnodeses"),
		SingularQualifiedResource: dijkstra.Resource("knownnodes"),
